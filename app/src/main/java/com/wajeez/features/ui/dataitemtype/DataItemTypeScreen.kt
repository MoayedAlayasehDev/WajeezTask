...
package com.wajeez.features.ui.dataitemtype
...
import com.wajeez.features.ui.theme.MyApplicationTheme
...
internal fun DataItemTypeScreen(
    ...
    Column(modifier) {
        ...
        Button(modifier = Modifier.wrapContentWidth(), onClick = { onSubscribe() }) {
            Text("Subscribe")
        }
...
private fun DefaultPreview() {
    MyApplicationTheme {
        DataItemTypeScreen(listOf("Compose", "Room", "Kotlin"), onSave = {}, onSubscribe = {})
    }
}
